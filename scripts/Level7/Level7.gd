...
const scnDuck  = preload("res://scenes/Levels/Level7/Duck7.tscn")
const scnHalfFruit  = preload("res://scenes/halfFruit.tscn")
const scnBoss  = preload("res://scenes/Levels/Level7/Boss7.tscn")
...
func spawnFruit():
	...
	if fruitHit < fruitHitMax:
		...
		spawnBoss()
	if fruitHit != 0 and duckContainer.get_child_count() < maxDucks:
		spawnDuck()
		pass
